...
def gondola_go_to( x, y ):
    global current_x, current_y, x_steps_skew, y_steps_skew, command_running

    command_running = True
    print( "> gondola_go_to( " + str(x) + ", " + str(y) + " )" )
    x = x * (100.0-2*gondola_reserve_margin)/100.0 + gondola_reserve_margin
    y = y * (100.0-2*gondola_reserve_margin)/100.0 + gondola_reserve_margin
    print( ">              ( " + str(x) + ", " + str(y) + " )" )
    ...
    for i in range(len(steps_to_take)):
        if steps_to_take[i]=="l":
            gondola_step_left( 1, times_to_sleep[i], l_direction )
        else:
            gondola_step_right( 1, times_to_sleep[i], r_direction )
